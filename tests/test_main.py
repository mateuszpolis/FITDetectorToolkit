...
from fitdetectortoolkit.main import ModuleManager, FITDetectorToolkit
...
class TestModuleManager:
    ...
    def test_load_modules_config_new(self):
        ...
        with patch.object(ModuleManager, 'save_modules_config') as mock_save:
            ...
            assert manager.modules["AgeingAnalysis"]["url"] == "https://github.com/mateuszpolis/AgeingAnalysis.git"
            mock_save.assert_called_once()
    
    def test_save_modules_config(self):
...
class TestFITDetectorToolkit:
    ...
    def test_init(self, mock_style, mock_tk):
    ...
    @patch('tkinter.Tk')
    @patch('tkinter.ttk.Style')
    def test_configure_styles(self, mock_style, mock_tk):
    ...
    @patch('tkinter.Tk')
    @patch('tkinter.ttk.Style')
    def test_install_module(self, mock_style, mock_tk):
        ...
        with patch.object(app.module_manager, 'install_module') as mock_install:
            ...
            with patch.object(app, 'refresh_ui') as mock_refresh:
    ...
    @patch('tkinter.Tk')
    @patch('tkinter.ttk.Style')
    def test_launch_module(self, mock_style, mock_tk):
